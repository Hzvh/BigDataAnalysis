...
public class CallLog {
    ...
    private String id_date_dimenstion;
    ...
    public String getId_date_dimenstion() {
        return id_date_dimenstion;
    }

    public void setId_date_dimenstion(String id_date_dimenstion) {
        this.id_date_dimenstion = id_date_dimenstion;
    }
